      ...
      <footer className="bg-[#202020] py-8 px-4">
        <div className="rightLogos flex justify-between  px-3 pr-5 ">
          <div className="flex gap-3">
            <img className="w-6" src="/fb.svg" alt="fb" />
            <img className="w-6" src="/tw.svg" alt="tw" />
            <img className="w-6" src="/yt.svg" alt="yt" />
          </div>
          <button
            className="flex items-center justify-center border-[2px] border-white w-8 h-8 cursor-pointer"
            onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
            aria-label="Back to top"
          >
            <img className="w-3" src="/top.svg" alt="back to top" />
          </button>
        </div>
        ...
        <div className=" max-w-[850px] mt-10 text-[13px] text-[#FFFFFF99] px-3">
          <p>
        ...
        <div className="mt-7 text-[15px] text-white flex justify-between px-3 pr-5 ">
          ...
          <img className=" w-5" src="/Vector.svg" alt="vector" />
          {/* </div> */}
        </div>
      </footer>
    </section>
