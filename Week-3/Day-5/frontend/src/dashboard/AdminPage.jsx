    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Add Product */}
          <div className="group border border-gray-200 hover:border-black transition-colors duration-200">
            <Link to="/add-product" className="block p-8 h-full">
              <div className="flex items-center justify-between mb-6">
                <div className="w-12 h-12 bg-black flex items-center justify-center">
                  <span className="text-white text-xl">+</span>
                </div>
                <div className="w-6 h-6 border border-gray-300 group-hover:border-black transition-colors"></div>
              </div>
